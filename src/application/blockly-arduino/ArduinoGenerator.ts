import { initControl } from "./blocks/Control";
import { initLogic } from "./blocks/Logic";
...
// Creates the predefined block code-generators
...
export function initBlockly(){
    ...
    */
    Blockly.Arduino.init = function(workspace: any) {
        ...
        for (var x = 0; x < variables.length; x++) {
          console.log("Var: ",variables[x]);
            ...
            defvars[x] = 'int ' +
                    Blockly.Arduino.nameDB_.getName(variables[x].name,
                    Blockly.Variables.DEVELOPER_VARIABLE) + ';\n';
        }
   ...
   * @private
   */
  Blockly.Arduino.scrub_ = function(block: any, code: string) {
    if (code === null) {
